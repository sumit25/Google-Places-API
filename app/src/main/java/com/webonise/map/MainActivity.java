...
public class MainActivity extends AppCompatActivity {
    ...
    private static final LatLngBounds BOUNDS_PUNE = new LatLngBounds(
            new LatLng(-34.041458, 18.5204), new LatLng(-33.682247, 151.383362));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPlacesAdapter = new PlacesAutoCompleteAdapter(this, android.R.layout.simple_list_item_1,
                mGoogleApiClient, BOUNDS_PUNE, null);
